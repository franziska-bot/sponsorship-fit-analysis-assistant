...
- [Capstone Showcase](#capstone-showcase)
...
**Before proceeding, keep in mind that it is highly recommended to participate in the available workshops and open sessions for this module.**
...
**Objective**: Evaluate the effects of tuning LLM parameters (e.g., temperature, max tokens, reasoning effort) on output quality.
...
After completing your project, you’ll have the opportunity to present it to the group during your standup; a chance to share what you built, get feedback, and see what your peers created.

**Before your presentation, upload your project to [showcase.turingcollege.com](https://showcase.turingcollege.com/).** This is where everyone can explore and upvote each other’s work, and it only takes a few minutes. 

**Format:** 10 minutes to present, followed by 5 minutes for questions.

To give your presentation a clear structure, try to cover these six points:

1. **The problem** — What are you solving, who is it for, and why does it matter?
2. **Your solution** — What did you build? Walk through the architecture, models, and key tools.
3. **The data** — What data did you work with, and how did you prepare or handle it?
4. **Evaluation** — How did you measure success? Share your metrics and results.
5. **Challenges** — What was the hardest technical problem, and how did you solve it?
6. **What’s next** — What would you improve or build with more time?

These questions help you tell a complete story from problem to outcome; and make for a much stronger presentation than a live demo alone.
